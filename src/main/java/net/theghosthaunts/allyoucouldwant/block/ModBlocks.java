package net.theghosthaunts.allyoucouldwant.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(AllYouCouldWant.MODID);

    public static final DeferredBlock<Block> Eternal_Log = registerBlock("eternal_log",
